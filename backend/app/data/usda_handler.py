...
class USDAHandler:
    ...
    def load_data(self):
        ...
        try:
            with open(settings.usda_foundation_path, 'r', encoding='utf-8') as f:
            ...
            with open(settings.usda_sr_legacy_path, 'r', encoding='utf-8') as f:
            ...
            print(f"Loaded {len(self.foundation_foods)} foundation foods and {len(self.legacy_foods)} legacy foods")
